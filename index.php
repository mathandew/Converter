    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="about.html">Downloads</a></li>
          <li><a href="contact.html">Contact</a></li>
          <li><a href="login.php">Signin as Admin</a></li>
        </ul>
          ...
          <div class="col-lg-6 mx-auto">
            <div class="col-lg-6 mx-auto">
              <div class="text-center">
                <h2 class="text-center">Enter Your Number to Get Details</h2>
                <form id="userForm" class="row g-3">
                  <div class="col-12">
                    <input type="number" id="userId" name="pers_number" class="form-control"
                      placeholder="Enter Personal Number" required>
                  </div>
                  <div class="col-12">
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button onclick="downloadImage('png')" class="btn btn-danger">Download as PNG</button>
                      <button onclick="downloadImage('jpeg')" class="btn btn-warning">Download as JPEG</button>
                    </div>
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6 footer-about">
            ...
            <div class="footer-contact pt-3">
              ...
              <p class="mt-3">Phone: <span>+1 5589 55488 55</span></p>
    ...
    <div class="copyright text-center">
      <div
        ...
        <div class="d-flex flex-column align-items-center align-items-lg-start">
          <div>
            © Copyright <span>MyWebsite</span>. All Rights Reserved
          </div>
          <div class="credits">
  ...
  <script>
        ...
        .then(data => {
          if (data.status === "success") {
            ...
            document.getElementById("modalBody").innerHTML = `
                <div class="container p-3" id="captureArea" style="
                    background: white; 
                    font-size: 14px; 
                    ...
                    color: black;
                ">
                    <strong style="padding-left:50px;">${user.city}

                    <div>
                        S#: ${user.id} <span style="padding-left:150px;">P Sec: ${user.p_section} Month: ${user.month}</span>
                        <span style="padding-left:150px;">HB0379 - TEO HYDERABAD TALUKA (M) P</span> <br>
                        Pers #: ${user.pers_number} <span style="padding-left:100px;">Buckle: ${user.buckle}</span><span style="padding-left:100px;">${user.department}</span> <br>
                        Name: ${user.name}<span style="padding-left:100px;">NTN: ${user.ntn}</span> <br>
                        <span style="padding-left:30px;">${user.designation}</span><span style="padding-left:150px;">GPF #: ${user.gpf_number}</span> <br>
                        CNIC No: ${user.nic}<span style="padding-left:150px;">Old #: </span>
                        <p>GPF Interest Applied</p>

                        <span style="padding-left:30px;">01 Active Temporary</span> <span style="padding-left:200px;">HB0379 -</span>
                    </div>

                    <div>
                        PAYS AND ALLOWANCES:
                        <table style="width: 100%; text-align: left; border-collapse: collapse;">
                            <tr><td style="padding-left:30px;">0001-Basic Pay</td><td style="text-align: right; padding-right:100px;">${user.basic_pay}</td></tr>
                            <tr><td>1001-House Rent Allowance 45%</td><td style="text-align: right; padding-right:100px;">${user.house_rent_allowance}</td></tr>
                            <tr><td>1210-Conveyance Allowance 2005</td><td style="text-align: right; padding-right:100px;">${user.conveyance_allowance}</td></tr>
                            <tr><td>1300-Medical Allowance</td><td style="text-align: right; padding-right:100px;">${user.medical_allowance}</td></tr>
                            <tr><td>1567-Washing Allowance</td><td style="text-align: right; padding-right:100px;">${user.health_professional_allowance}</td></tr>
                            <tr><td>2347-Adhoc Rel 15% 22(P517)</td><td style="text-align: right; padding-right:100px;">${user.adhoc_relief_15_percent}</td></tr>
                            <tr><td>2349-Differential Allw (01-15)</td><td style="text-align: right; padding-right:100px;">${user.differential_allowance}</td></tr>
                            <tr><td>2378-Adhoc Relief All 2023 35%</td><td style="text-align: right; padding-right:100px;">${user.adhoc_relief_2023}</td></tr>
                            <tr><td>2395-Adhoc Relief All 2024 30%</td><td style="text-align: right; padding-right:100px;">${user.adhoc_relief_2024}</td></tr>
                            <tr>
                                <td>Gross Pay and Allowances</td>
                                <td style="text-align: right;">${user.gross_pay}</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <p>DEDUCTIONS:</p>
                  <div>
                      <span style="">GPF Balance</span> <span style="padding-left:30px;">${user.gpf_balance}</span>
                      <span style="padding-left:150px;">Subrc</span> <span style="padding-left:30px;">${user.subrc}</span> <br>
                      <span style="">3505-Benevolent Fund Sind1-5</span> <span style="padding-left:230px;">${user.benevolent_fund}</span> <br>
                      <span style="">3508-Group Insurance Sindh</span> <span style="padding-left:230px;">${user.group_insurance}</span> <br>
                  </div>
                <br>
                <br>
                <br>
                <br>
                    <p><span style="">Total Deductions</span> <span style="padding-left:230px;">${user.total_deductions}</span></p>
                    <p><span style="padding-left:400px;">${user.total_payable}</p>

                    <div>
                        <span style="padding-left:40px;">D.O.B <span style="padding-left:30px;">LFP Quota:</span> <span style="padding-left:10px;">${user.lfp_quota}</span> <br>
                        <span style="padding-left:30px;">${user.date_of_birth}</span> <span style="padding-left:50px;">${user.bank_name}</span> <br>
                        <span style="">${user.service_duration}</span> <span style="padding-left:30px;">${user.bank_account_number}</span>
                    </div>
                </div>
            `;
          } else {
    ...
    function downloadImage(format = "png") {
      ...
      html2canvas(captureArea, {
        ...
        link.download = `Salary_Slip.${format}`;
        link.click();
      });
    }
  </script>
